...
export namespace InscricaoEstadual {
	export class Para {
		...
		private static readonly STARTS_WITH = "15";
		private static readonly VERIFIER_DIGIT_WEIGHTS = [9, 8, 7, 6, 5, 4, 3, 2];

		private static readonly MASK_REGEX = /^(\d{2})(\d{6})(\d{1})$/;
		...
		/**
		 * PT-BR: Verifica se uma inscrição estadual do Pará é válida.
		 *
		 * EN: Checks if an Pará state registration is valid.
		 *
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Para.isValid("111117905"); // false
		 * InscricaoEstadual.Para.isValid("154877905"); // true
		 * ```
		 */
		...
		/**
		 * PT-BR: Máscara uma inscrição estadual do Pará.
		 *
		 * EN: Masks an Pará state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Para.mask("154877905"); // "15-487790-5"
		 * ```
		 */
		...
		/**
		 * PT-BR: Desmascara uma inscrição estadual do Pará.
		 *
		 * EN: Unmasks an Pará state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Para.unmask("15-487790-5"); // "154877905"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gerar um número de inscrição estadual do Pará válido.
		 *
		 * EN: Generate a valid Pará state registration number.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado. EN: The generated state registration number.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.Para.generate(); // "154877905"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gera um número de inscrição estadual do Pará válido e aleatório com máscara.
		 *
		 * EN: Generates a random valid Pará state registration number with mask.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado com máscara. EN: The generated state registration number with mask.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.Para.generateMasked(); // "15-487790-5"
		 * ```
		 */
