...
export namespace InscricaoEstadual {
	export class Tocantins {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Tocantins.isValid("1111110310"); // false
		 * InscricaoEstadual.Tocantins.isValid("00130000019"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Tocantins.mask("00130000019"); // "0013000001-9"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Tocantins.unmask("0013000001-9"); // "00130000019"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Tocantins.generate(); // "00130000019"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Tocantins.generateMasked(); // "0013000001-9"
		 * ```
		 */
