...
export namespace InscricaoEstadual {
	export class RioDeJaneiro {
		...
		private static readonly VALID_LENGTH = 8;
		...
		private static readonly VERIFIER_DIGIT_WEIGHTS = [2, 7, 6, 5, 4, 3, 2];

		private static readonly MASK_REGEX = /^(\d{2})(\d{3})(\d{2})(\d{1})$/;
		...
		/**
		 * PT-BR: Verifica se uma inscrição estadual do Rio de Janeiro é válida.
		 *
		 * EN: Checks if an Rio de Janeiro state registration is valid.
		 *
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RioDeJaneiro.isValid("1111110310"); // false
		 * InscricaoEstadual.RioDeJaneiro.isValid("00130000019"); // true
		 * ```
		 */
		...
		/**
		 * PT-BR: Máscara uma inscrição estadual do RioDeJaneiro.
		 *
		 * EN: Masks an Rio de Janeiro state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RioDeJaneiro.mask("00130000019"); // "0013000001-9"
		 * ```
		 */
		...
		/**
		 * PT-BR: Desmascara uma inscrição estadual do RioDeJaneiro.
		 *
		 * EN: Unmasks an Rio de Janeiro state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RioDeJaneiro.unmask("0013000001-9"); // "00130000019"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gerar um número de inscrição estadual do Rio de Janeiro válido.
		 *
		 * EN: Generate a valid Rio de Janeiro state registration number.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado. EN: The generated state registration number.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.RioDeJaneiro.generate(); // "00130000019"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gera um número de inscrição estadual do Rio de Janeiro válido e aleatório com máscara.
		 *
		 * EN: Generates a random valid Rio de Janeiro state registration number with mask.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado com máscara. EN: The generated state registration number with mask.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.RioDeJaneiro.generateMasked(); // "0013000001-9"
		 * ```
		 */
