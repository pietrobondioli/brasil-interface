...
export namespace InscricaoEstadual {
	export class DF {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.DF.isValid("11111111001-53"); // false
		 * InscricaoEstadual.DF.isValid("07985681001-53"); // true
		 * InscricaoEstadual.DF.isValid("1111111100153"); // false
		 * InscricaoEstadual.DF.isValid("0798568100153"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.DF.mask("0798568100153"); // "07985681001-53"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.DF.unmask("07985681001-53"); // "0798568100153"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.DF.generate(); // "0798568100153"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.DF.generateMasked(); // "07985681001-53"
		 * ```
		 */
