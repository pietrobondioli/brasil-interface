...
export class RS {
	...
	private static readonly VERIFIER_DIGIT_WEIGHTS = [2, 9, 8, 7, 6, 5, 4, 3, 2];
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RS.isValid("1111322855"); // false
	 * InscricaoEstadual.RS.isValid("7015322855"); // true
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RS.mask("7015322855"); // "701/5322855"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RS.unmask("701/5322855"); // "7015322855"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RS.generate(); // "7015322855"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RS.generateMasked(); // "701/5322855"
	 * ```
	 */
