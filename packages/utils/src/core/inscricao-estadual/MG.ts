...
export class MG {
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.MG.isValid("01.004.823/001-12"); // false
	 * InscricaoEstadual.MG.isValid("01.954.726/538-84"); // true
	 * InscricaoEstadual.MG.isValid("0100482300112"); // false
	 * InscricaoEstadual.MG.isValid("0195472653884"); // true
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.MG.mask("0195472653884"); // "01.954.726/538-84"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.MG.unmask("01.954.726/538-84"); // "0195472653884"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.MG.generate(); // "0195472653884"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.MG.generateMasked(); // "01.954.726/538-84"
	 * ```
	 */
	...
	private static calculateVerifierDigits(baseNumerals: string): string {
		const baseNumeralsForFirstDigit = this.put0BeforeBaseNumerals(baseNumerals);
