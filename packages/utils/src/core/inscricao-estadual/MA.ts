...
export namespace InscricaoEstadual {
	export class MA {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.MA.isValid("1111110310"); // false
		 * InscricaoEstadual.MA.isValid("301188327"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.MA.mask("301188327"); // "30118832-7"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.MA.unmask("30118832-7"); // "301188327"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.MA.generate(); // "301188327"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.MA.generateMasked(); // "30118832-7"
		 * ```
		 */
