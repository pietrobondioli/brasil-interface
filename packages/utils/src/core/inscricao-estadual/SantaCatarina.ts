...
export namespace InscricaoEstadual {
	export class SantaCatarina {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SantaCatarina.isValid("111210825"); // false
		 * InscricaoEstadual.SantaCatarina.isValid("081210825"); // true
		 * InscricaoEstadual.SantaCatarina.isValid("081.210.825"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SantaCatarina.mask("081210825"); // "081.210.825"
		 * InscricaoEstadual.SantaCatarina.mask("081.210.825"); // "081.210.825"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SantaCatarina.unmask("081.210.825"); // "081210825"
		 * InscricaoEstadual.SantaCatarina.unmask("081210825"); // "081210825"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SantaCatarina.generate(); // "081210825"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SantaCatarina.generateMasked(); // "081.210.825"
		 * ```
		 */
