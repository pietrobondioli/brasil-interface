...
export namespace InscricaoEstadual {
	export class SP {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SP.isValid("1111110310"); // false
		 * InscricaoEstadual.SP.isValid("301188327"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SP.mask("301188327"); // "30118832-7"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SP.unmask("30118832-7"); // "301188327"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SP.generate(); // "301188327"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.SP.generateMasked(); // "30118832-7"
		 * ```
		 */
