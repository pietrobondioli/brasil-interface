...
export class GO {
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.GO.isValid("1111110310"); // false
	 * InscricaoEstadual.GO.isValid("109876547"); // true
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.GO.mask("109876547"); // "10.987.654-7"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.GO.unmask("10.987.654-7"); // "109876547"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.GO.generate(); // "109876547"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.GO.generateMasked(); // "10.987.654-7"
	 * ```
	 */
