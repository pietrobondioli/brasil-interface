...
export namespace InscricaoEstadual {
	export class RJ {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RJ.isValid("1111110310"); // false
		 * InscricaoEstadual.RJ.isValid("00130000019"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RJ.mask("00130000019"); // "0013000001-9"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RJ.unmask("0013000001-9"); // "00130000019"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RJ.generate(); // "00130000019"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RJ.generateMasked(); // "0013000001-9"
		 * ```
		 */
