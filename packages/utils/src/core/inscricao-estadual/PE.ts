...
export class PE {
	...
	private static readonly FIRST_VERIFIER_DIGIT_WEIGHTS = [8, 7, 6, 5, 4, 3, 2];
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PE.isValid("111.11583-00"); // false
	 * InscricaoEstadual.PE.isValid("292.33583-00"); // true
	 * InscricaoEstadual.PE.isValid("1111158300"); // false
	 * InscricaoEstadual.PE.isValid("2923358300"); // true
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PE.mask("2923358300"); // "292.33583-00"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PE.unmask("292.33583-00"); // "2923358300"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PE.generate(); // "2923358300"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PE.generateMasked(); // "292.33583-00"
	 * ```
	 */
