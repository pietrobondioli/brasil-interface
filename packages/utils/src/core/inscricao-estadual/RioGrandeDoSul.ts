...
export namespace InscricaoEstadual {
	export class RioGrandeDoSul {
		...
		private static readonly MASK_REGEX = /^(\d{3})(\d{7})$/;
		...
		/**
		 * PT-BR: Verifica se uma inscrição estadual do Rio Grande do Sul é válida.
		 *
		 * EN: Checks if an Rio Grande do Sul state registration is valid.
		 *
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RioGrandeDoSul.isValid("1111322855"); // false
		 * InscricaoEstadual.RioGrandeDoSul.isValid("7015322855"); // true
		 * ```
		 */
		...
		/**
		 * PT-BR: Máscara uma inscrição estadual do Rio Grande do Sul.
		 *
		 * EN: Masks an Rio Grande do Sul state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RioGrandeDoSul.mask("7015322855"); // "701/5322855"
		 * ```
		 */
		...
		/**
		 * PT-BR: Desmascara uma inscrição estadual do Rio Grande do Sul.
		 *
		 * EN: Unmasks an Rio Grande do Sul state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.RioGrandeDoSul.unmask("701/5322855"); // "7015322855"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gerar um número de inscrição estadual do Rio Grande do Sul válido.
		 *
		 * EN: Generate a valid Rio Grande do Sul state registration number.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado. EN: The generated state registration number.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.RioGrandeDoSul.generate(); // "7015322855"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gera um número de inscrição estadual do Rio Grande do Sul válido e aleatório com máscara.
		 *
		 * EN: Generates a random valid Rio Grande do Sul state registration number with mask.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado com máscara. EN: The generated state registration number with mask.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.RioGrandeDoSul.generateMasked(); // "701/5322855"
		 * ```
		 */
