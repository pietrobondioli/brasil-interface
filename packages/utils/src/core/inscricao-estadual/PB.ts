...
export class PB {
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PB.isValid("111117905"); // false
	 * InscricaoEstadual.PB.isValid("154877905"); // true
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PB.mask("154877905"); // "15-487790-5"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PB.unmask("15-487790-5"); // "154877905"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PB.generate(); // "154877905"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.PB.generateMasked(); // "15-487790-5"
	 * ```
	 */
