...
export namespace InscricaoEstadual {
	export class Piaui {
		...
		/**
		 * PT-BR: Verifica se uma inscrição estadual do Piaui é válida.
		 *
		 * EN: Checks if an Piaui state registration is valid.
		 *
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Piaui.isValid("1111110310"); // false
		 * InscricaoEstadual.Piaui.isValid("00130000019"); // true
		 * ```
		 */
		...
		/**
		 * PT-BR: Máscara uma inscrição estadual do Piaui.
		 *
		 * EN: Masks an Piaui state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Piaui.mask("00130000019"); // "0013000001-9"
		 * ```
		 */
		...
		/**
		 * PT-BR: Desmascara uma inscrição estadual do Piaui.
		 *
		 * EN: Unmasks an Piaui state registration.
		 *
		 * @param inscricaoE - PT-BR: A inscrição estadual. Com ou sem máscara. EN: The state registration. With or without mask.
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Piaui.unmask("0013000001-9"); // "00130000019"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gerar um número de inscrição estadual do Piaui válido.
		 *
		 * EN: Generate a valid Piaui state registration number.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado. EN: The generated state registration number.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.Piaui.generate(); // "00130000019"
		 * ```
		 */
		...
		/**
		 * PT-BR: Gera um número de inscrição estadual do Piaui válido e aleatório com máscara.
		 *
		 * EN: Generates a random valid Piaui state registration number with mask.
		 *
		 * @returns PT-BR: O número de inscrição estadual gerado com máscara. EN: The generated state registration number with mask.
		 *
		 * @example
		 * ```
		 * InscricaoEstadual.Piaui.generateMasked(); // "0013000001-9"
		 * ```
		 */
