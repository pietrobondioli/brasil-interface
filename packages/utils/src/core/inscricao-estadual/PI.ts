...
export namespace InscricaoEstadual {
	export class PI {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PI.isValid("1111110310"); // false
		 * InscricaoEstadual.PI.isValid("00130000019"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PI.mask("00130000019"); // "0013000001-9"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PI.unmask("0013000001-9"); // "00130000019"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PI.generate(); // "00130000019"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PI.generateMasked(); // "0013000001-9"
		 * ```
		 */
