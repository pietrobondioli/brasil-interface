...
export class RO {
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RO.isValid("11111958422341"); // false
	 * InscricaoEstadual.RO.isValid("20811958422341"); // true
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RO.mask("20811958422341"); // "2081195842234-1"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RO.unmask("2081195842234-1"); // "20811958422341"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RO.generate(); // "20811958422341"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RO.generateMasked(); // "2081195842234-1"
	 * ```
	 */
