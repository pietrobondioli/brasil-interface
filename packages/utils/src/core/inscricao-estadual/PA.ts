...
export namespace InscricaoEstadual {
	export class PA {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PA.isValid("111117905"); // false
		 * InscricaoEstadual.PA.isValid("154877905"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PA.mask("154877905"); // "15-487790-5"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PA.unmask("15-487790-5"); // "154877905"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PA.generate(); // "154877905"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.PA.generateMasked(); // "15-487790-5"
		 * ```
		 */
