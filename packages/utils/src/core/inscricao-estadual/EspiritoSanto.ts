...
export namespace InscricaoEstadual {
	export class EspiritoSanto {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.EspiritoSanto.isValid("1111110310"); // false
		 * InscricaoEstadual.EspiritoSanto.isValid("301188327"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.EspiritoSanto.mask("301188327"); // "30118832-7"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.EspiritoSanto.unmask("30118832-7"); // "301188327"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.EspiritoSanto.generate(); // "301188327"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.EspiritoSanto.generateMasked(); // "30118832-7"
		 * ```
		 */
