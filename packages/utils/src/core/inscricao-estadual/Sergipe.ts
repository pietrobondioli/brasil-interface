...
export namespace InscricaoEstadual {
	export class Sergipe {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Sergipe.isValid("111556610"); // false
		 * InscricaoEstadual.Sergipe.isValid("585556610"); // true
		 * InscricaoEstadual.Sergipe.isValid("58555661-0"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Sergipe.mask("585556610"); // "58555661-0"
		 * InscricaoEstadual.Sergipe.mask("58555661-0"); // "58555661-0"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Sergipe.unmask("58555661-0"); // "585556610"
		 * InscricaoEstadual.Sergipe.unmask("585556610"); // "585556610"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Sergipe.generate(); // "585556610"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.Sergipe.generateMasked(); // "58555661-0"
		 * ```
		 */
