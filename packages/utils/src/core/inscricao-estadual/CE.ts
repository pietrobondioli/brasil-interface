...
export namespace InscricaoEstadual {
	export class CE {
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.CE.isValid("11111004-0"); // false
		 * InscricaoEstadual.CE.isValid("39509004-0"); // true
		 * InscricaoEstadual.CE.isValid("111110040"); // false
		 * InscricaoEstadual.CE.isValid("395090040"); // true
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.CE.mask("395090040"); // "39509004-0"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.CE.unmask("39509004-0"); // "395090040"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.CE.generate(); // "395090040"
		 * ```
		 */
		 ...
		 * @example
		 * ```
		 * InscricaoEstadual.CE.generateMasked(); // "39509004-0"
		 * ```
		 */
