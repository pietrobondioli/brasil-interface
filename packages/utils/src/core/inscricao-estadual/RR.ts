...
export class RR {
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RR.isValid("11111958422341"); // false
	 * InscricaoEstadual.RR.isValid("20811958422341"); // true
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RR.mask("20811958422341"); // "2081195842234-1"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RR.unmask("2081195842234-1"); // "20811958422341"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RR.generate(); // "20811958422341"
	 * ```
	 */
	 ...
	 * @example
	 * ```
	 * InscricaoEstadual.RR.generateMasked(); // "2081195842234-1"
	 * ```
	 */
